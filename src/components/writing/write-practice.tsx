...
export function WritePractice() {
  ...
  const studied = useMemo(() => hiraganaCharacters.filter((kana) => snapshot?.introducedIds.includes(`hiragana:${kana.character}`)), [snapshot]);
