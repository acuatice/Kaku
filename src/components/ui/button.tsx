...
const variants: Record<ButtonVariant, string> = {
  primary: "bg-[var(--kaku-purple)] text-white hover:bg-[#2d107a]",
...
const base = "inline-flex min-h-12 items-center justify-center gap-2 rounded-[var(--radius-button)] px-5 text-sm font-semibold transition duration-150 active:scale-[.98] focus-visible:outline-2 focus-visible:outline-offset-2 disabled:pointer-events-none disabled:opacity-45";
